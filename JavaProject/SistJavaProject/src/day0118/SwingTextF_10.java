...
public class SwingTextF_10 extends JFrame {
	...
	public void initDesign() {
		...
		btnAdd = new JButton("+");
		btnAdd.setBounds(20, 110, 50, 50);
		this.add(btnAdd);

		btnM = new JButton("-");
		btnM.setBounds(80, 110, 50, 50);
		this.add(btnM);

		btnG = new JButton("*");
		btnG.setBounds(140, 110, 50, 50);
		this.add(btnG);

		btnN = new JButton("/");
		btnN.setBounds(200, 110, 50, 50);
		this.add(btnN);

		lblResult = new JLabel("결과 나오는 곳..");
		lblResult.setBounds(20, 170, 250, 60);
		lblResult.setBorder(new TitledBorder(new LineBorder(Color.BLACK, 2), "결과확인"));
